...
## Project Structure
    ...
    ├── testgenerateapp_dev_34948  # Django project configurations
...
1. Clone this repo and `cd testgenerateapp_dev_34948`
...
2. Clone this repo and `cd testgenerateapp_dev_34948`
